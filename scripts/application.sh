...
declare -a XBB_APPLICATION_DEPENDENCIES=( binutils-ld-gold llvm )
declare -a XBB_APPLICATION_COMMON_DEPENDENCIES=( libiconv autoconf automake libtool pkg-config zlib libffi ncurses libiconv xz libxml2 libedit )
