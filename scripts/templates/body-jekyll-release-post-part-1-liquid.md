...
- LLVM clang version 0.11.0, the development commit
[<xxxxxxx>](https://github.com/xpack-dev-tools/clang/commit/<xxxxxxxxxxxxx>)
from <ddddddddd>.
...
- the `src/clang.c` file was edited to display the branding string
- the `contrib/60-clang.rules` file was simplified to avoid protection
  related issues.
...
```sh
.../xpack-clang-{{ RELEASE_VERSION }}/bin/clang -f board/stm32f4discovery.cfg
```
