...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/clang?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/clang/)
...
distribution of LLVM clang,
intended for reproducible builds.

## Project documentation

For information on how to install and use this project, please refer to the
[project web site](https://xpack-dev-tools.github.io/clang-xpack/).

## Project source

The source code of the current release is available on
[GitHub tag v19.1.6-1.1 tree](https://github.com/xpack-dev-tools/clang-xpack/tree/v19.1.6-1.1).
