...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/clang/17.0.1-1.1/.content/
/Users/ilg/Library/xPacks/@xpack-dev-tools/clang/17.0.1-1.1/.content/
├── README.md
├── bin
...
│   ├── libclang.dylib
│   ├── libear
│   ├── liblldb.17.0.1.dylib
│   ├── liblldb.dylib -> liblldb.17.0.1.dylib
│   ├── libscanbuild
│   ├── libunwind.1.0.dylib
...
like `17.0.1`; to this string the xPack distribution adds a four number,
but since semver allows only three numbers, all additional ones can
be added only as pre-release strings, separated by a dash,
like `17.0.1-1`. When published as a npm package, the version gets
a fifth number, like `17.0.1-1.1`.

Since adherence of third party packages to semver is not guaranteed,
it is recommended to use semver expressions like `^17.0.1` and `~17.0.1`
with caution, and prefer exact matches, like `17.0.1-1.1`.
