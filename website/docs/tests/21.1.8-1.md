...
title: xPack LLVM clang 21.1.8-1 test results
description: The report of running the tests on all supported platforms.

date: 2026-03-05 15:38:57 +0000
...
```txt
Tests summary for clang 21.1.8-1 on darwin-x64 (macOS 15.7.4)

315 test cases passed, 0 skipped, 4 failed:
...
- lto-throwcatch-main ✗
  ```txt
  [/Users/runner/work/clang-xpack/clang-xpack/build-assets/build/darwin-x64/x86_64-apple-darwin24.6.0/tests/clang-xpack/xpacks/.bin/clang++ throwcatch-lib.cpp -shared -fpic -o libthrowcatch-lib.dylib -L/Users/runner/Library/xPacks/@xpack-dev-tools/clang/21.1.8-1.1/.content/lib -L/Users/runner/Library/xPacks/@xpack-dev-tools/clang/21.1.8-1.1/.content/lib/clang/21/lib/darwin -Wl,-rpath,/Users/runner/Library/xPacks/@xpack-dev-tools/clang/21.1.8-1.1/.content/lib -Wl,-rpath,/Users/runner/Library/xPacks/@xpack-dev-tools/clang/21.1.8-1.1/.content/lib/clang/21/lib/darwin -flto -std=c++11]
  ld: warning: reexported library with install name '@rpath/libunwind.1.0.dylib' found at '/Users/runner/Library/xPacks/@xpack-dev-tools/clang/21.1.8-1.1/.content/lib/libunwind.1.0.dylib' couldn't be matched with any parent library and will be linked directly
...
```txt
Tests summary for clang 21.1.8-1 on darwin-arm64 (macOS 15.7.4)

319 test cases passed, 0 skipped
...
```txt
Tests summary for clang 21.1.8-1 on linux-x64 (Debian 12)

1755 test cases passed, 16 skipped
...
```txt
Tests summary for clang 21.1.8-1 on linux-arm64 (Debian 12)

863 test cases passed, 8 skipped
