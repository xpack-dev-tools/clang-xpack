...
title: Getting Started with xPack LLVM clang
...
**xPack LLVM clang** is a standalone
cross-platform (Windows, macOS, GNU/Linux)binary distribution of LLVM clang,
...
[release assets](https://github.com/xpack-dev-tools/clang-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/clang-xpack/tree/xpack/build-assets/scripts).
...
The details of installing the **xPack LLVM clang** on various platforms are
presented in the
...
[GitHub Discussions](https://github.com/xpack-dev-tools/clang-xpack/discussions/).
...
[`clang-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/clang-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/clang-xpack/): It helps others discover our work.
