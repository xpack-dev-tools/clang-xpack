...
# How to get help for the xPack LLVM clang
...
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/clang-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/clang-xpack/discussions)
pages.
