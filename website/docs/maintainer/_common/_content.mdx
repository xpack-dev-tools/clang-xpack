...
(such as **20.1.8-1.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v20.1.8-1 released**_
...
tagged such as **v20.1.8-1** (mind the dash in the middle!) and
named such as **xPack LLVM clang v20.1.8-1** (mind the dash),
...
- **Commit** all changes with the message
  _**package.json: update URLs for 20.1.8-1.1 release**_
