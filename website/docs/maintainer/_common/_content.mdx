...
(such as **19.1.7-1.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v19.1.7-1 released**_
...
tagged such as **v19.1.7-1** (mind the dash in the middle!) and
named such as **xPack LLVM clang v19.1.7-1** (mind the dash),
