...
* <code>xpack-clang-{customField('upstreamVersion')}-{customField('xpackSubversion')}-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}</code>
* <code>xpack-clang-{customField('upstreamVersion')}-{customField('xpackSubversion')}-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}.sha</code>
