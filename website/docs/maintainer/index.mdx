...
title: How to make new xPack LLVM clang releases
...
Replace **{customField('upstreamVersion')}** with the following expression:
...
named like **xPack LLVM clang v{customField('upstreamVersion')}-{customField('xpackSubversion')}** (mind the dash),
...
npm dist-tag add @xpack-dev-tools/clang@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')} latest
npm dist-tag ls @xpack-dev-tools/clang
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/clang@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack LLVM clang v{customField('upstreamVersion')}-{customField('xpackSubversion')} released**_
