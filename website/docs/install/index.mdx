...
- <code>xpack-clang-{customField('xpackVersion')}-win32-x64.zip</code>
...
- <code>xpack-clang-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-clang-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-clang-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-clang-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-clang-{customField('xpackVersion')}-linux-arm.tar.gz</code>
