...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/clang/19.1.7-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/clang/19.1.7-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/clang/19.1.7-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-clang-19.1.7-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\clang\\xpack-clang-19.1.7-1</code>.
...
<ul>
<li><code>xpack-clang-19.1.7-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-clang-19.1.7-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/clang/xpack-clang-19.1.7-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/clang
cd ~/Library/xPacks/clang

tar xvf ~/Downloads/xpack-clang-19.1.7-1-darwin-x64.tar.gz
chmod -R -w xpack-clang-19.1.7-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-clang-19.1.7-1-linux-x64.tar.gz</code></li>
<li><code>xpack-clang-19.1.7-1-linux-arm64.tar.gz</code></li>
<li><code>xpack-clang-19.1.7-1-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/clang/xpack-clang-19.1.7-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/clang
cd ~/.local/xPacks/clang

tar xvf ~/Downloads/xpack-clang-19.1.7-1-linux-x64.tar.gz
chmod -R -w xpack-clang-19.1.7-1
`} </CodeBlock>
