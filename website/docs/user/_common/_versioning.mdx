...
upstream {props.upstreamName ? props.upstreamName : 'LLVM clang'} project
is a three-number string
such as <code>20.1.8</code>;
...
such as <code>20.1.8-<b>1</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>20.1.8-1.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack LLVM clang dependency via
SemVer expressions
such as <code>^20.1.8-1</code> or <code>~20.1.8-1</code>, and
prefer exact matches,
such as <code>20.1.8-1.1</code>.
