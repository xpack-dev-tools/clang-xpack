...
title: clang predefined macros
description: The built-in preprocessor macros defined by clang.
keywords:
  - xpack
  - clang
  - c++
...
When compiling with clang 13 on Windows, the following built-in definitions are available:

```console
$ /c/Users/ilg/AppData/Roaming/xPacks/@xpack-dev-tools/clang/13.0.1-1.1/.content/bin/clang.exe  -E -dM - </dev/null | sort
#define WIN32 1
#define WIN64 1
#define WINNT 1
#define _WIN32 1
...
#define __VERSION__ "xPack MinGW-w64 x86_64 Clang 13.0.1"
