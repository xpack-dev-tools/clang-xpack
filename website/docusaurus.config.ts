...
const config: Config = {
  title: 'xPack LLVM clang' +
    ((process.env.DOCUSAURUS_IS_PREVIEW === 'true') ? ' (preview)' : ''),
  tagline: 'A binary distribution of LLVM clang',
  ...
  projectName: 'clang-xpack', // Usually your repo name.
  ...
  plugins: [
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        editUrl: 'https://github.com/xpack-dev-tools/clang-xpack/edit/website/website/',
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/clang-xpack/discussions',
            },
            {
