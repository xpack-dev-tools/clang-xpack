...
```console
/Users/ilg/Work/clang-15.0.7-1/darwin-x64/sources/llvm-project-15.0.7.src/llvm/utils/TableGen/GlobalISelEmitter.cpp:4298:7: error: no matching function for call to 'makeArrayRef'
      makeArrayRef({&BuildVector, &BuildVectorTrunc}));
      ^~~~~~~~~~~~
/Users/ilg/Work/clang-15.0.7-1/darwin-x64/sources/llvm-project-15.0.7.src/llvm/include/llvm/ADT/ArrayRef.h:458:15: note: candidate template ignored: couldn't infer template argument 'T'
...
```console
[/home/runner/Work/linux-x64/tests/xpack-clang-15.0.7-1/bin/clang++ simple-exception.cpp -o crt-simple-exception -rtlib=compiler-rt -stdlib=libc++ -fuse-ld=lld]
