...
file; the format is `15.0.7-3`. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like `15.0.7-3`).
...
- add a new entry like _* v15.0.7-3 prepared_
- commit with a message like _prepare v15.0.7-3_
...
- add a `v15.0.7-3-xpack` tag; enable push to origin
...
total 198256
-rw-r--r--  1 ilg  staff  96214029 Jan 21 01:18 xpack-clang-15.0.7-3-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff       105 Jan 21 01:18 xpack-clang-15.0.7-3-darwin-x64.tar.gz.sha
```
...
total 165320
-rw-r--r--  1 ilg  staff  84138150 Jan 27 03:56 xpack-clang-15.0.7-3-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff       107 Jan 27 03:56 xpack-clang-15.0.7-3-darwin-arm64.tar.gz.sha
```
...
total 182596
-rw-r--r-- 1 ilg ilg 186973037 Jan 20 09:00 xpack-clang-15.0.7-3-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg       104 Jan 20 09:00 xpack-clang-15.0.7-3-linux-x64.tar.gz.sha
```
...
total 375640
-rw-r--r-- 1 ilg ilg 384645944 Jan 21 01:35 xpack-clang-15.0.7-3-win32-x64.zip
-rw-r--r-- 1 ilg ilg       101 Jan 21 01:35 xpack-clang-15.0.7-3-win32-x64.zip.sha
```
...
total 143972
-rw-r--r-- 1 ilg ilg 147419140 Jan 21 08:14 xpack-clang-15.0.7-3-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg       106 Jan 21 08:14 xpack-clang-15.0.7-3-linux-arm64.tar.gz.sha
```
...
total 124300
-rw-r--r-- 1 ilg ilg 127272460 Jan 21 06:20 xpack-clang-15.0.7-3-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg       104 Jan 21 06:20 xpack-clang-15.0.7-3-linux-arm.tar.gz.sha
```
...
bash ~/Work/xpack-dev-tools/clang-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbla64
...
```sh
.../xpack-clang-15.0.7-3/bin/clang --version
...
- in `CHANGELOG.md`, add the release date and a message like _* v15.0.7-3 released_
...
tagged like **v15.0.7-3** (mind the dash in the middle!) and
named like **xPack LLVM clang v15.0.7-3** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack LLVM clang v15.0.7-3 released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for 15.0.7-3.1 release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _* v15.0.7-3.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v15.0.7-3.1_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 15.0.7-3.1`; the first 4 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/clang@15.0.7-3.1 latest`
- `npm dist-tag ls @xpack-dev-tools/clang`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/clang@15.0.7-3.1`
...
- paste the release name like **xPack LLVM clang v15.0.7-3 released**
